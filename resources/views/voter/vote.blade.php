...
<div class="page-stack max-w-5xl mx-auto">
    <section class="page-hero">
        ...
        <p class="page-subtitle">Select one candidate per position.</p>
    </section>
                        ...
                        <label class="candidate-option">
                            ...
                            <div class="flex items-center gap-4">
                                @if(!empty($candidate->photo_url))
                                    <img src="{{ $candidate->photo_url }}" alt="{{ $candidate->name }}" class="h-16 w-16 rounded-xl object-cover border border-slate-200">
                                @else
                                ...
                                <div class="flex-1">
                                    ...
                                    <a href="{{ route('voter.vote.candidate.show', [$election, $candidate]) }}" class="btn-tertiary relative z-10 -ml-2 mt-2">View Manifesto</a>
                                </div>
                            </div>
                        </label>
                    @endforeach
        ...
        <div class="sticky-submit-bar">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <p class="text-sm text-slate-500">Submit once all visible positions are selected.</p>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const updateProgress = () => {
        ...
        if (progressCount) progressCount.textContent = selected;
